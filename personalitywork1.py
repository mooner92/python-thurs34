...
for i in range(10):
    A, B, C = random.randrange(100,1000),random.randrange(100,1000),random.randrange(100,1000)
    print("A가 펼친 페이지 = %d , B가 펼친 페이지 = %d , C가 펼친 페이지 = %d"%(A,B,C))
...
if (Score[0] == Score[1] or Score[1] == Score[2] or Score[0] == Score[2]):
    Rep = sorted(Score)
    pe1, pe2 = "A", "B"
